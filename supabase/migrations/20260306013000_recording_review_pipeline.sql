...
begin
  ...
  if exists (
    ...
    set
      ...
      meaning_en = coalesce(nullif(btrim(meaning_en), ''), nullif(btrim(english_translation), ''), nullif(btrim(malay_translation), ''), nullif(btrim(meaning_ms), '')),
      english_translation = coalesce(nullif(btrim(english_translation), ''), nullif(btrim(meaning_en), ''), nullif(btrim(malay_translation), ''), nullif(btrim(meaning_ms), '')),
