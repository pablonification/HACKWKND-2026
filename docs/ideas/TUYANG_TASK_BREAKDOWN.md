...
| TTS | Google Nano Banana | Pronunciation generation |
| Image Gen | Google Nano Banana | Story illustrations |
...
|------|-------|-------------|--------|
| Initialize React Native (Expo) + TypeScript | Both | Repo created | ✅ Done |
| Set up Supabase project + schema | Both | Tables ready | ⏳ In progress |
| Implement Supabase Auth | Both | Sign up/login works | ✅ Done |
| Install NativeWind + MMKV | Dev A | Storage ready | ✅ Done (NativeWind), ⚠️ MMKV replaced with AsyncStorage for Expo Go compatibility |
| Create shared UI components | Dev A | Buttons, cards, inputs | ⏳ In progress |
| Set up navigation structure | Both | App flow defined | ✅ Done |
...
| AI Helper - Nano Banana stub | Dev B | TTS endpoint ready | ⬜ Not started |
...
| Story Archive - Nano Banana images | Dev B | Illustrations generate | ⬜ Not started |
...
- [ ] Nano Banana TTS integration
- [ ] Nano Banana Image Gen integration
...
- [ ] Illustration generation (Nano Banana)
...
**Document Version:** 1.1 (Updated: NativeWind + MMKV)  
**Created:** March 2026  
**Hackathon:** BorNEO HackWknd 2026
